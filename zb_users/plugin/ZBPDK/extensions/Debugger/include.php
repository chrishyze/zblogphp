...
{
    global $zbp;
    if ('1' == $zbp->Config('ZBPDK_Debugger')->show_in_front) {
...
{
    global $zbp;
    if ('1' == $zbp->Config('ZBPDK_Debugger')->show_in_admin) {
...
<script src="' . $zbp->host . 'zb_users/plugin/ZBPDK/extensions/Debugger/script.js"></script>';
    echo $html;
